...
#         self.max_num_groups = 6          # Number of paths (N_P)
#         self.max_seq_len = 77            # Number of commands (N_C)
#         self.max_total_len = 82          # Concatenated sequence length for baselines
        
        self.max_num_groups = 8          # Number of paths (N_P)
        self.max_seq_len = 34            # Number of commands (N_C)
        self.max_total_len = 48          # Concatenated sequence length for baselines
